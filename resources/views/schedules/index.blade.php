...
@section('content')
<style>
    .row-ok { background-color: #d1e7dd !important; } /* Verde Sucesso do Bootstrap */
    .btn-toggle-off { color: #ccc; border: 1px solid #ccc; }
    .btn-toggle-on { color: white; background-color: #198754; border: 1px solid #198754; }
</style>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Agendar Programa</h5>
